...
const translations: Record<Locale, SiteCopy> = {
  en: {
    ...
    home: {
      ...
      aboutParagraphs: [
        "Hi, I’m Tanie Lalwani — and honestly, I didn’t get into tech because I had some perfectly planned roadmap. It started with curiosity. I liked making things, breaking things, redesigning things that annoyed me, and obsessing over tiny details most people probably never notice. Somewhere between staying up too late fixing alignment issues, rebuilding projects for no reason except “this could feel smoother,” and endlessly experimenting with interfaces, I realized I cared less about just writing code and more about creating experiences people actually remember.",
        "Over the last few years, that curiosity slowly turned into 130+ projects — from React interfaces, full-stack builds, landing pages, frontend systems, and interactive web experiences to ideas that probably sounded unreasonable at 2AM but somehow turned into something real. I’ve spent 2+ years freelancing as a creative developer, working with founders, creators, startups, and personal brands to turn rough ideas into polished digital experiences that feel intentional, memorable, and human. Somewhere along the way, I became slightly obsessed with the intersection of aesthetics and engineering — the idea that something can feel beautiful, fast, useful, and emotionally memorable all at once. <span class=\"link-text\">Projects</span> · <span class=\"link-text\">Selected work</span> · <span class=\"link-text\">Case studies</span>",
        "A huge part of my growth has come from simply showing up — hackathons, tech communities, conferences, volunteering, late-night building sessions, overcommitting to ideas I wasn’t fully ready for, and learning in public as I went. I’ve won hackathons, collaborated on fast-moving builds, experimented with product ideas under impossible deadlines, and slowly realized that the best opportunities usually come from curiosity, consistency, and putting your work where people can see it. More recently, I’ve become increasingly interested in open-source, developer tooling, design systems, and the kind of work that sits between building products and helping people understand technology better. <span class=\"link-text\">Hackathons</span> · <span class=\"link-text\">Community</span> · <span class=\"link-text\">Open source</span>",
        "Outside building products, I spend a lot of time creating content and building in public — sharing experiments, documenting what I’m learning, talking about frontend engineering, creative development, internet identity, branding, creator strategy, UI trends, and interesting things happening across tech. Whether it’s project breakdowns, industry commentary, lessons from freelancing, thoughts on design and engineering, or simply sharing things I wish someone told me earlier, I genuinely enjoy the storytelling side of tech. I love turning complicated ideas into something people actually understand and making technology feel exciting instead of intimidating — which is probably why developer advocacy, community-driven work, and dev-rel style spaces feel so interesting to me. <span class=\"link-text\">LinkedIn</span> · <span class=\"link-text\">Content</span> · <span class=\"link-text\">Build in public</span>",
        "And outside of tech, I make music and content. Over the last year, I’ve been releasing tracks, experimenting with visuals, storytelling, creative direction, and documenting the process of building a creative identity online. Whether it’s music, videos, tech, or ideas — I care about making things people connect with, remember, and maybe even feel inspired to create something of their own after seeing.",
      ],
      knowMore: "Know more",
