...
export const languageOptions: LanguageOption[] = [
  ...
  { locale: "hi", code: "HN", label: "Hinglish" },
...
const translations: Record<Locale, SiteCopy> = {
    ...
    home: {
      ...
      projects: [
        ...
        },
        {
          ...
          previewVideo: "/viziona-preview.mp4",
          previewOpacity: "opacity-95",
  ...
  hi: {
    nav: {
      qna: "QnA",
      languages: "Languages",
      interviewPrompt: "Mera interview yahan lein",
      homeLabel: "Home",
      contactLabel: "Contact",
    },
    loading: {
    ...
    home: {
      heroTitle: "Main hoon Tanie!",
      heroRole: "Creative Developer",
      heroDescription:
        "Chalo aapki website ko aapka best 24/7 salesperson banayein.",
      ctaWork: "Mera Kaam",
      ctaPricing: "Pricing & Calculator",
      aboutTitle: "Thoda mere baare mein:",
      aboutParagraphs: [
        "Hi, main hoon Tanie Lalwani, India se ek creative aur full-stack developer. Main data science graduate hoon aur tech mein 16 ki age mein enter hua tha. Time ke saath mujhe data, blockchain, ML, dev-rel aur regular tech buzzwords mein interest raha, par jo cheez sabse zyada pasand aayi wo thi web design.",
        "Mujhe aisi websites pasand aati hain jo alag dikhein — sirf functional nahi, memorable. Isi curiosity ne mujhe interactive web experiences, 3D websites, motion aur lively frontend design ki taraf push kiya.",
        "Pichle kuch saalon mein, maine 100+ projects banaye hain landing pages, web apps, interactive platforms aur different tech stacks par. 2+ saalon se founders, creators, startups aur personal brands ke saath freelance kaam kar raha hoon.",
        "Meri shuruati growth hackathons, tech communities, volunteering, fast deadlines, freelancing aur public mein learn karne se hui, aur ab apne aas-paas ke logon se seekh kar.",
        "Tech ke alawa, main music banata hoon, content create karta hoon, visual art, fashion aur naye hobbies try karta rehta hoon. Kisi na kisi tarah, humein saath kaam karne mein maza zaroor aayega.",
      ],
      aboutParagraphsMobile: [
        "Hi, main hoon Tanie Lalwani, India se creative full-stack developer aur data science graduate. 16 ki age mein tech shuru kiya tha aur sab kuch explore karne ke baad hamesha web design par wapas aata raha.",
        "Main memorable websites banata hoon: interactive UI, 3D web, smooth motion aur aisi frontend jo lively lage.",
        "Maine 100+ projects banaye hain aur founders, creators aur startups ke saath 2+ saal freelancing ki hai.",
        "Hackathons, tech communities, fast deadlines aur public learning ne mere kaam karne ka tareeqa banaya.",
        "Tech ke alawa, main music, content aur visuals banata hoon aur naye hobbies experiment karta rehta hoon.",
      ],
      knowMore: "Aur Jaanein",
      projectsTitle: "Kaam aur Testimonials:",
      contactTitle: "Chalo saath milkar banayein...",
      openToLabel: "Available for:",
      openToAriaLabel: "Web development services ke liye available",
      services: [
        "Portfolio Websites",
        "Landing Pages",
        "Web Apps",
      ...
      projects: [
        {
          title: "UAE ATS & Recruiter AI Resume Generator",
          description:
            "UAE ke recruiters aur ATS standards ke liye specially trained AI resume builder. Recruiter feedback aur job description ke basis par perfect resume customize karta hai.",
          techStack: ["React", "TypeScript", "AI / LLM", "ATS Optimization", "Tailwind CSS"],
          site: "https://emiratescv.in",
          previewVideo: "/UAEResume.mp4",
          previewOpacity: "opacity-95",
          detailVideo: "/UAEResume.mp4",
          details: [
            "UAE job market ke liye specially designed intelligent AI resume generator, jo ATS filters aur recruiter preferences ko prioritize karta hai.",
            "Recruiter feedback aur job description matching use karke ye keywords, formatting aur impact metrics ko optimize karta hai taaki interviews maximize hon."
          ],
        },
        {
          title: "Viziona",
          description:
            "Immersive 3D scenes ke saath AI-powered visualization & manifestation experience. Apna dream goal (country, city, lifestyle ya dream) describe karein aur plain text ke bajaye cinematic customized 3D environment paayein.",
          techStack: ["React", "TypeScript", "Three.js", "Tailwind CSS"],
          site: "https://viziona.vercel.app/",
          code: "https://github.com/tanie-lalwani/viziona",
          previewVideo: "/viziona-preview.mp4",
          ...
          detailVideo: "/viziona-full.mp4",
          details: [
            "Viziona ek AI-powered visualization/manifestation experience hai jahan users apna dream goal describe karte hain aur unhe interactive 3D spatial scenes milte hain.",
            "Ye prototype proof-of-concept ke roop mein design kiya gaya hai, jo dynamic AI-driven virtual worlds ke foundation ko show karta hai."
          ],
        },
        {
          title: "Checkout Performance Overhaul - FinchPay",
          description:
            "Fast checkout flows, clear states aur smooth feedback ke liye frontend performance optimization.",
          techStack: ["React", "TypeScript", "Performance"],
          site: "https://finchpay.app",
        },
        {
          title: "Marketing Site Rebuild - Leafline",
          description:
            "Behtar content structure, responsive layouts aur calm visual aesthetic ke saath modern frontend rebuild.",
          techStack: ["React", "TypeScript", "Web development"],
          site: "https://leafline.studio",
        },
      ],
      featuredProject: {
        title: "Innomedia",
        description:
          "Ek clean 360 degree marketing company website, jise lean HTML aur CSS se banaya gaya aur motion, animated reveals aur flexible layouts se elevate kiya gaya.",
        techStack: ["HTML", "CSS", "Flex", "Animation"],
        details: [
          "Innomedia ek 360 degree marketing company site hai, jise simple service storytelling, clear page flow aur quick visual trust ke around banaya gaya. Base intentionally lean tha: HTML, CSS aur direct content structure.",
          "Basic stack ke bawajood isme animated reveals, soft transitions aur layout rhythm add kiya gaya taaki site static brochure se zyada alive lage.",
        ],
      },
    },
    qna: {
      questions: [
        ...
        "Kisi aise project ke baare mein batayein jis par aapko proud feel hota hai.",
        "Production mein bugs ko kaise handle karte hain?",
        "Kabhi kisi teammate ke saath disagreement hua ho toh batayein.",
        "Frontend performance ko kaise optimize karte hain?",
        "Aap ye role kyu join karna chahte hain?",
      ],
      homeLabel: "Home",
      contactLabel: "Contact",
      videoPlaceholder: "Video Placeholder",
    ...
    footer: {
      role: "Creative Developer",
      copyright: "© 2026 Tanie Lalwani : React, TypeScript, Three.js aur dher saari coffee ke saath banaya gaya.",
    },
    contact: {
      labels: {
        name: "Aapka Naam",
      ...
      placeholders: {
        ...
        subject: "Kis baare mein baat karni hai?",
        message: "Apne project ke baare mein batayein...",
      },
      button: "Message Send Karein",
      sending: "Bhej rahe hain...",
      success: "Message chala gaya! Main jaldi hi reply karunga.",
      error: "Message send nahi ho paya. Please dobara try karein.",
      networkError: "Network error. Connection check karein aur retry karein.",
      endpointError: "Form endpoint configured nahi hai.",
    },
    projectCard: {
      view: "Dekhein",
      code: "Code",
      projectsCountSuffix: "projects",
      allProjects: "Sabhi Projects",
      projectDetails: "Project Details",
      closeDetails: "Details Band Karein",
      open: "Kholein",
      demoLabel: "Live Demo",
      defaultProjectDetails: [
        "Viziona ko ek polished product surface ki tarah banaya gaya hai jisme responsive layout, clear visual hierarchy aur smooth interaction states par strong focus hai.",
        "Ye project modern React aur TypeScript workflow ke saath high performance, clean motion aur multi-device responsiveness deliver karta hai.",
      ],
    },
  },
  ja: {
