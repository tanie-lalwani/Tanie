...
export function AuthModal({
  ...
  }, [user, loading, isOpen, nextTarget, onClose, router]);
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-zinc-950/95 backdrop-blur-2xl p-6 sm:p-7 shadow-2xl text-white">
        {/* Close Button */}
        <button
          type="button"
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-xl text-zinc-400 hover:text-white hover:bg-white/10 transition cursor-pointer"
        ...
        <div className="flex flex-col items-center text-center pb-5">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-cyan-500 to-purple-600 flex items-center justify-center font-bold text-white shadow-lg shadow-purple-500/20 mb-3">
            TL
          </div>
          ...
          <p className="text-xs text-zinc-400 mt-1">
            Access your client workspace, live project updates, and contracts.
          </p>
        </div>
        ...
        {feedback && (
          <div
            className={`mb-4 p-3 rounded-xl text-xs flex items-start gap-2 border leading-relaxed ${
              feedback.type === "error"
        ...
        {showForgot ? (
              ...
              <div className="space-y-3 pt-2 text-center">
                <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4 text-xs text-zinc-200 space-y-1">
                  ...
                  <p className="text-zinc-400 leading-relaxed text-[11px]">
                    We sent secure reset instructions to <strong className="text-white">{email}</strong>.
                  </p>
                </div>
                <button
                  type="button"
                  className="px-3.5 py-1.5 text-xs rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 text-white cursor-pointer"
          ...
          <div>
            {/* Tabs */}
            <div className="grid grid-cols-2 gap-1 bg-white/5 p-1 rounded-2xl mb-4">
              <button
                type="button"
                onClick={() => {
                  setActiveTab("signin");
            ...
            <button
              ...
              disabled={busy}
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-white/15 bg-white/[0.04] hover:bg-white/[0.08] text-white text-sm font-medium transition cursor-pointer disabled:opacity-50 mb-4"
            >
