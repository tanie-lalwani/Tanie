...
export const packagesTranslations: Record<Locale, PackagesPageCopy> = {
  ...
  hi: {
    ...
    hero: {
      titlePrefix: "Apni website ka ",
      titleHighlight: "Cost Calculate Karein",
      subtitle: "Apne business ka social handle ya details dalein aur apne goals ke hisaab se instant, transparent price estimate paayein.",
      inputPlaceholder: "Business handle ya details dalein (e.g. @brand, website, phone ya email)",
      ctaButton: "Price Calculate Karein ✈",
      trustInstant: "Instant Estimate",
      trustTransparent: "100% Transparent",
      trustNoPush: "No Sales Pressure",
      foundationTitle: "Ya customise karne ke liye apna website base chunein:",
      foundations: {
        business: {
          title: "Business / Brand",
          desc: "Brand authority banayein, inquiries attract karein aur kaam showcase karein.",
        },
        portfolio: {
          title: "Portfolio / Creator",
          desc: "Artists, agencies aur founders ke liye impactful visual showcase.",
        },
        ecommerce: {
          title: "Online Store (E-Commerce)",
          desc: "Full product catalog, 1-click checkout, UPI aur card payments.",
        },
        saas: {
          title: "SaaS & Web App",
          desc: "Authentication, dashboards aur database ke saath interactive web application.",
        },
      },
    },
    funnel: {
      step1Title: "Aapka main goal ya challenge kya hai?",
      step1Subtitle: "Apna primary goal chunein — hum automatically best package modules configure kar denge:",
      step2Title: "Recommended Packages & Custom Modules",
      step2Subtitle: "Aapke goal ke hisaab se tailored high-performance modules. Jarurat ke mutabik features adjust karein.",
      step3Title: "Launch Timeline & Budget",
      step3Subtitle: "Humein apna target launch date aur investment budget batayein.",
      step4Title: "Review Karein & Apna Quote Unlock Karein",
      step4Subtitle: "Aapke selected configuration ke basis par itemized scope breakdown.",
      step5Title: "Review Karein & Quote Unlock Karein",
      step5Subtitle: "Aapke selected configuration ke basis par itemized scope breakdown.",
      backBtn: "← Peeche Jaayein",
      nextBtn: "Agla Step →",
      calculateBtn: "Estimate Calculate Karein ✨",
      unlockTitle: "Poora Quote Save & Unlock Karein",
      unlockSubtitle: "Is pricing ko lock karne aur planning shuru karne ke liye apna free client profile banayein.",
      nameLabel: "Aapka Naam",
      emailLabel: "Work Email",
      passwordLabel: "Password",
      signupTab: "Account Banayein",
      signinTab: "Sign In",
      unlockBtn: "Proposal Unlock & Save Karein",
      instantDemoBtn: "⚡ 1-Click Instant Demo",
      whatsappShare: "WhatsApp Par Share Karein 💬",
      proceedBooking: "Project Booking Ke Liye Aage Badhein →",
      includedBase: "Base Foundation Included",
      totalInvestment: "Total Investment",
      bundleDiscount: "Modular Delta Discount Applied",
    },
    categories: {
      all: "Sabhi",
      editorial: "Editorial & Luxury",
    ...
    aesthetics: {
      showCatalog: "Visual Aesthetics Catalog Dekhein",
      showMatrix: "18 Categories Detailed Scope Matrix",
      colorDna: "Signature Color DNA",
      inspectPreview: "Interactive Preview",
      chooseStyle: "Ye Style Chunein →",
    },
    addons: {
      tag: "Add-on Modules",
      title: "Sprint Add-ons",
      cms: {
        name: "Headless CMS (Sanity / Contentful)",
        desc: "Self-manageable visual content aur blog management.",
      },
      ai: {
        name: "AI Copilot (Gemini / OpenAI)",
        desc: "Aapke business par trained 24/7 lead qualification AI assistant.",
      },
      audio: {
        name: "Spatial Audio & Micro-Sound Design",
        desc: "Reactive sound effects aur ambient background controls.",
      },
    },
    intakeModal: {
      title: "Project Scope & Intake Brief",
      subtitle: "Apni requirements fill karein taaki tailored sprint plan banaya ja sake.",
      projectName: "Project Ka Naam",
      clientName: "Full Name",
      clientEmail: "Email Address",
      companyName: "Company / Brand Name",
      purpose: "Goal & Vision",
      pages: "Approx Pages Count",
      timeline: "Target Timeline",
      submit: "Intake Brief Submit Karein",
      submitting: "Submit ho raha hai...",
      success: "Proposal successfully send ho gaya! Redirect kar rahe hain...",
      close: "Band Karein",
    },
  },
  ja: {
