...
export const faqTranslations: Record<Locale, FaqPageCopy> = {
  ...
  hi: {
    badge: "सहायता केंद्र एवं सामान्य प्रश्न",
    title: "अक्सर पूछे जाने वाले प्रश्न (FAQ)",
    subtitle: "प्रोजेक्ट स्कोप, मूल्य निर्धारण, 3D WebGL अनुभव, डिलीवरी समयसीमा और क्लाइंट डिलिवरेबल्स से जुड़े सभी सवालों के स्पष्ट उत्तर।",
    searchPlaceholder: "प्रश्न और विषय खोजें (उदा. कीमत, समयसीमा, 3D, Razorpay, वारंटी)...",
    questionsFound: (count) => `${count} प्रश्न मिले`,
    expandAll: "सभी खोलें",
    collapseAll: "सभी बंद करें",
    noQuestionsTitle: (query) => `"${query}" से मेल खाता कोई प्रश्न नहीं मिला`,
    noQuestionsSubtitle: "क्या आपका कोई विशेष प्रश्न है जो यहाँ नहीं है? बेझिझक सीधे संपर्क करें।",
    resetButton: "खोज रीसेट करें",
    keyTakeawaysLabel: "मुख्य बिंदु:",
    categories: [
      { id: "all", label: "सभी प्रश्न" },
      { id: "services", label: "सेवाएं एवं कार्यक्षेत्र" },
      { id: "pricing", label: "मूल्य एवं भुगतान" },
      { id: "timeline", label: "समयसीमा एवं डिलीवरी" },
      { id: "tech", label: "3D एवं तकनीकी स्टैक" },
      { id: "portal", label: "क्लाइंट वर्कस्पेस" },
      { id: "warranty", label: "वारंटी एवं सहायता" },
    ],
    items: [
      {
        id: "services-offered",
        category: "services",
        categoryLabel: "सेवाएं एवं कार्यक्षेत्र",
        question: "आप किस प्रकार की वेबसाइट और डिजिटल अनुभव बनाते हैं?",
        answer: [
          "मैं कस्टम हाई-कन्वर्टिंग लैंडिंग पेज, 3D WebGL इंटरैक्टिव वेबसाइट्स और सुरक्षित क्लाइंट पोर्टल के साथ फुल-स्टैक Next.js वेब ऐप्स बनाने में विशेषज्ञ हूँ।",
          "प्रत्येक प्रोजेक्ट बिना किसी भारी वर्डप्रेस टेम्पलेट के बिल्कुल नए और आधुनिक कोड के साथ तैयार किया जाता है।",
        ],
        keyPoints: [
          "Figma में डिज़ाइन किया गया कस्टम UI/UX",
          "Three.js और React Three Fiber के साथ 3D दृश्य",
          "अल्ट्रा-फास्ट Next.js 15 आर्किटेक्चर",
        ],
      },
      {
        id: "payment-milestones",
        category: "pricing",
        categoryLabel: "मूल्य एवं भुगतान",
        question: "भुगतान माइलस्टोन और डिपॉज़िट कैसे काम करते हैं?",
        answer: [
          "कस्टम प्रोजेक्ट्स में 50% अग्रिम अनुबंध के समय और शेष 50% कार्य की अंतिम स्वीकृति पर लाइव होने से पहले देय होता है।",
          "वेबसाइट से सीधे खरीदे गए पैकेज का भुगतान तुरंत लिया जाता है और इनवॉइस के साथ वर्कस्पेस ऐक्सेस तुरंत मिल जाता है।",
        ],
      },
      {
        id: "turnaround-timeline",
        category: "timeline",
        categoryLabel: "समयसीमा एवं डिलीवरी",
        question: "वेबसाइट बनने में कितना समय लगता है?",
        answer: [
          "समयसीमा प्रोजेक्ट के स्तर पर निर्भर करती है:",
        ],
        keyPoints: [
          "लैंडिंग पेज: 1 से 2 सप्ताह",
          "3D वेब अनुभव: 3 से 5 सप्ताह",
          "फ़ुल-स्टैक वेब ऐप्स: 4 से 6 सप्ताह",
        ],
      },
      {
        id: "warranty-period",
        category: "warranty",
        categoryLabel: "वारंटी एवं सहायता",
        question: "वेबसाइट लॉन्च के बाद क्या सहायता मिलती है?",
        answer: [
          "हाँ! प्रत्येक प्रोजेक्ट में 30 दिनों की निःशुल्क वारंटी शामिल होती है जिसमें किसी भी बग को बिना अतिरिक्त शुल्क के ठीक किया जाता है।",
        ],
      },
    ],
    bottomCta: {
      title: "क्या आपका कोई विशेष प्रोजेक्ट या सवाल है?",
      description: "आइए साथ मिलकर कुछ यादगार बनाएं। अपनी आवश्यकताओं पर चर्चा करें या लागत कैलकुलेटर का उपयोग करें।",
      explorePricing: "मूल्य एवं पैकेज देखें →",
      contactDirectly: "सीधे संपर्क करें",
      termsLink: "नियम एवं नीतियां →",
    },
  },
