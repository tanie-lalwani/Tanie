...
export const termsTranslations: Record<Locale, TermsPageCopy> = {
  ...
  hi: {
    badge: "Legal, Compliance & Client Agreements",
    title: "Terms & Policies",
    subtitle: "Hamare unified Terms of Service, Privacy Policy, Milestone-based Refund Rules aur Digital Service Delivery Agreement ek hi jagah.",
    searchPlaceholder: "Topic ya clause search karein (e.g. refunds, Razorpay, source code, warranty, delivery)...",
    filterLabel: "Topic Ke Hisaab Se Filter Karein:",
    noResultsTitle: (query) => `"${query}" ke liye koi clause nahi mila`,
    noResultsSubtitle: "Thode broader keywords search karein jaise refunds, payment, warranty ya filters reset karein.",
    resetButton: "Filters Reset Karein",
    showingCount: (sections, clauses) => `${sections} Sections (${clauses} Clauses)`,
    sectionLinkLabel: "Section Link",
    quickLinks: {
      faq: "FAQ Dekhein →",
    ...
    sections: [
      {
        ...
        topic: "Terms of Service",
        topicId: "terms",
        title: "1. Engagement Terms & Service Scope",
        badge: "Engagement Agreement",
        lastUpdated: "September 11, 2026",
        clauses: [
          {
            heading: "1.1 Overview & Scope of Services",
            content: [
              "Ye Terms and Conditions Tanie Lalwani (\"Developer\", \"Studio\") dwara clients (\"Client\") ko provide ki jaane wali bespoke creative engineering, UI/UX design, 3D WebGL development aur full-stack software development services ko govern karti hain.",
              "Kisi project ko commission karke, package choose karke ya payment submit karke aap in terms se fully agree karte hain.",
            ],
          },
          {
            heading: "1.2 Project Milestones & Client Workspace",
            content: [
              "Har project transparent aur agreed milestones mein structured hota hai (jaise Discovery, 3D Interaction & UI Design, Frontend Development, Staging Review aur Final Production Launch).",
              "Sabhi project deliverables, staging preview links aur asset transfers centrally Client Workspace mein record hote hain.",
            ],
          },
          {
            heading: "1.3 Client Obligations & Timely Feedback",
            content: [
              "Project timeline meet karne ke liye Client brand assets, content materials aur timely milestone feedback review window ke andar provide karne par agree karta hai.",
            ],
          },
          {
            heading: "1.4 30-Day Hypercare Warranty & Post-Launch Support",
            content: [
              "Sabhi completed websites aur custom web apps mein live domain launch ke baad 30 days ki complimentary hypercare warranty included hoti hai.",
              "Ye warranty unexpected bugs, cross-browser layout issues aur performance fixes ko zero additional cost par cover karti hai.",
            ],
          },
          {
            heading: "1.5 Limitation of Liability",
            content: [
              "Applicable law ke according, Developer kisi 3rd party hosting outages (e.g. Vercel, AWS), external API breaks ya domain DNS issues ke indirect damages ke liye liable nahi hoga.",
            ],
          },
        ],
      },
        ...
        clauses: [
          {
            heading: "2.1 Retainer Deposits & Milestone Billing",
            content: [
              "Custom projects mein 50% upfront retainer deposit agreement sign karte time aur remaining 50% final staging review approve hone par production cutover se pehle pay hota hai.",
              "Directly purchased turnkey packages ka payment securely upfront process hota hai aur Client Workspace access turant issue ho jata hai.",
            ],
          },
          {
            heading: "2.2 Razorpay Payment Gateway & Security Compliance",
            content: [
              "Sabhi online payments, credit cards, UPI aur international transfers Razorpay payments infrastructure ke through securely process hote hain.",
              "Hum credit card numbers ya sensitive bank passwords store nahi karte. Razorpay PCI-DSS Level 1 certified hai aur strict security guidelines follow karta hai.",
            ],
          },
          {
            heading: "2.3 Invoices & Accepted Currencies",
            content: [
              "Sabhi invoices email aur Client Workspace mein available rehte hain. Supported currencies mein INR (₹), USD ($), EUR (€) aur AED (د.إ) included hain.",
            ],
          },
        ],
      },
      {
        ...
        topic: "Intellectual Property",
        topicId: "ip",
        title: "3. IP Rights & Code Ownership",
        badge: "Asset Ownership",
        lastUpdated: "September 11, 2026",
        clauses: [
          {
            heading: "3.1 Source Code & Asset Transfer",
            content: [
              "Project milestones ke full payment ke baad, specially develop kiya gaya source code, 3D scenes aur custom components permanently client ko transfer ho jaate hain.",
              "Client ke paas full commercial rights hote hain aur wo royalty-free code modify ya deploy kar sakte hain.",
            ],
          },
          {
            heading: "3.2 Third-Party & Open-Source Libraries",
            content: [
              "Web projects standard open-source libraries (jaise React, Next.js, Three.js, Tailwind CSS) use kar sakte hain jo MIT ya Apache 2.0 license ke under aati hain.",
            ],
          },
          {
            heading: "3.3 Portfolio Showcase Rights",
            content: [
              "Developer ke paas completed project ke non-confidential video previews aur screenshots apne portfolio aur case studies mein showcase karne ka right reserve rehta hai.",
            ],
          },
        ],
      },
      {
        ...
        topic: "Refunds & Cancellations",
        topicId: "refunds",
        title: "4. Milestone-Based Refund & Cancellation Policy",
        badge: "Refund Guidelines",
        lastUpdated: "September 11, 2026",
        clauses: [
          {
            heading: "4.1 Nature of Digital Engineering Services",
            content: [
              "Tanie Lalwani Studio custom digital design, 3D WebGL aur software development provide karta hai. Dedicated engineering time lagne ki wajah se refunds milestone structure par based hote hain.",
            ],
          },
          {
            heading: "4.2 Pre-Sprint 48-Hour Cancellation (100% Full Refund)",
            content: [
              "Agar client deposit pay karne ke 48 hours ke andar aur kaam shuru hone se pehle written cancellation request karta hai, toh 100% full refund (minus payment gateway fees) turant issue ho jata hai.",
            ],
          },
          {
            heading: "4.3 Milestone-Based Refund Rules",
            content: [
              "Discovery & Wireframing Stage: Agar client initial wireframes ke baad aage nahi badhna chahta, toh initial deposit ka 50% refund ho jata hai.",
              "Development & Staging Stage: Coding shuru hone aur staging live hone ke baad initial deposit non-refundable hota hai, par future milestone charges cancel ho jaate hain.",
              "Approved Final Launches: Client dwara officially approve aur deliver ho chuke projects par refund applicable nahi hota.",
            ],
          },
          {
            heading: "4.4 Refund Processing Timeline",
            content: [
              "Sabhi approved refunds Razorpay ke through 5 se 7 business days mein original payment method mein credit ho jaate hain.",
            ],
          },
          {
            heading: "4.5 Cancellation Ya Refund Request Kaise Karein",
            content: [
              "Project name aur payment transaction ID ke saath wordsofvoice2210@gmail.com par email karein. Hum 24 se 48 business hours mein revert karte hain.",
            ],
          },
        ],
      },
        ...
        clauses: [
          {
            heading: "5.1 100% Digital Delivery (No Physical Goods)",
            content: [
              "Tanie Lalwani Studio ki sabhi services (3D websites, web apps, design assets) 100% digital fulfillment ke through deliver hoti hain. Koi physical courier deliver nahi hota.",
            ],
          },
          {
            heading: "5.2 Delivery Channels & Digital Assets",
            content: [
              "Live Staging Link: Staging subdomains par testing preview.",
              "Source Code Handover: Private GitHub repository ownership transfer ya production build zip.",
              "Design Kits: Figma workspace access aur exported 3D GLB/vector files.",
              "Client Workspace Vault: Documents aur invoices ka secure digital archive.",
            ],
          },
          {
            heading: "5.3 Delivery Timelines",
            content: [
              "High-Converting Landing Pages: 1 se 2 weeks.",
              "3D Interactive & Brand Web Experiences: 3 se 5 weeks.",
              "Full-Stack Web Applications & MVPs: 4 se 6 weeks.",
            ],
          },
          {
            heading: "5.4 Staging Review & Final Approval",
            content: [
              "Staging delivery ke baad client ko 7 days ka review window milta hai taaki sabhi features test karke final production launch approve kiya ja sake.",
            ],
          },
        ],
      },
      {
        ...
        topic: "Privacy Policy",
        topicId: "privacy",
        title: "6. Privacy Policy & Data Protection",
        badge: "Data Protection",
        lastUpdated: "September 11, 2026",
        clauses: [
          {
            heading: "6.1 Information We Collect",
            content: [
              "Hum sirf wahi business ya contact information collect karte hain jo aap contact form, intake brief ya Razorpay payment ke time provide karte hain.",
            ],
          },
          {
            heading: "6.2 Use of Information",
            content: [
              "Aapki details sirf services deliver karne, client portal updates dene aur billing manage karne ke liye use hoti hain. Hum aapka data kisi 3rd party ko sell nahi karte.",
            ],
          },
          {
            heading: "6.3 Third-Party Infrastructure",
            content: [
              "Hum industry-standard reliable partners use karte hain: Supabase (encrypted database), Vercel (secure edge hosting) aur Razorpay (PCI-DSS certified payments).",
            ],
          },
          {
            heading: "6.4 Your Rights",
            content: [
              "Aap kisi bhi time apna personal data review karne ya permanently delete karne ke liye request kar sakte hain.",
            ],
          },
        ],
      },
      {
        ...
        topic: "Contact & Support",
        topicId: "support",
        title: "7. Official Contact & Support",
        badge: "Official Support",
        lastUpdated: "September 11, 2026",
        clauses: [
          {
            heading: "7.1 Contact Information",
            content: [
              "Terms, policies ya billing related sawalon ke liye directly email karein: wordsofvoice2210@gmail.com",
              "Website: https://tanie.me | Based in India, serving global businesses worldwide.",
            ],
          },
        ],
      },
