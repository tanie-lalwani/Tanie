...
export const qnaTranslations: Record<Locale, QnaPageTranslations> = {
  ...
  hi: {
    ...
    askTanie: "तानी से पूछें",
    thinking: "सोच रहा हूँ...",
    botGreeting: "नमस्ते! मैं तानी हूँ",
    botPlaceholder: "मेरे अनुभव या प्रोजेक्ट्स के बारे में कुछ भी पूछें...",
    send: "भेजें",
    transcripts: [
      "मैं तानी लालवानी हूँ, एक क्रिएटिव डेवलपर जो React, TypeScript, UI डिज़ाइन, फुल-स्टैक प्रयोगों और इंटरैक्टिव वेब अनुभवों पर केंद्रित है। मैं जिज्ञासा के माध्यम से तकनीक में आई: निर्माण करना, नया रूप देना, विवरणों को परिष्कृत करना और यादगार इंटरफेस बनाना।",
      "विज़िओना एक ऐसा प्रोजेक्ट है जिस पर मुझे बहुत गर्व है, क्योंकि यह उत्पाद कार्य के प्रति मेरी सोच को दर्शाता है: उत्तरदायी लेआउट, स्पष्ट इंटरैक्शन, दृश्य पदानुक्रम और व्यावहारिक निष्पादन।",
      "उत्पादन में बग्स को हल करते समय, मैं पहले समस्या को दोहराती हूँ, उपयोगकर्ता प्रभाव का आकलन करती हूँ, त्रुटि लॉग पढ़ती हूँ और कोड बदलने से पहले मूल कारण की पहचान करती हूँ।",
      "तकनीकी असहमति होने पर, मैं बातचीत को उपयोगकर्ता आवश्यकताओं, सीमाओं और प्रमाणों की ओर ले जाती हूँ। मैं उत्पाद की गुणवत्ता को प्राथमिकता देती हूँ।",
      "फ़्रंटएंड परफ़ॉर्मेंस के लिए, मैं बंडल साइज़, अनावश्यक रेंडर, इमेज ऑप्टिमाइज़ेशन और सटीक पैमाइश पर ध्यान देती हूँ।",
      "मैं ऐसी भूमिकाएं चाहती हूँ जहाँ मैं इंजीनियरिंग, डिज़ाइन संवेदनशीलता और उत्पाद सोच को जोड़ सकूँ ताकि उपयोगी और विचारशील डिजिटल अनुभव बनाए जा सकें।",
    ],
    nav: {
      home: "होम",
