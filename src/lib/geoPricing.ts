...
export const MARKET_TIERS: Record<string, MarketPricingTier> = {
  ...
  IN: {
    ...
    packages: {
      ...
      "booking-appointments-engine": 29999,
    ...
    bundles: {
      essential_core: 4999,
      sales_engine: 29999,
      marketing_campaigns: 29999,
      portals_dashboards: 24999,
      design_3d: 39999,
      fullstack_saas: 49999,
      // legacy aliases
      ecommerce_ordering: 29999,
      booking_appointments: 29999,
      lead_crm: 5499,
      ai_assistant: 6999,
  ...
  US: {
    ...
    bundles: {
      essential_core: 99,
      sales_engine: 599,
      marketing_campaigns: 599,
      portals_dashboards: 499,
      design_3d: 899,
      fullstack_saas: 999,
      // legacy aliases
      ecommerce_ordering: 599,
      booking_appointments: 599,
      lead_crm: 185,
      ai_assistant: 235,
      design_3d_gsap: 899,
      staff_portal: 499,
  ...
  GB: {
    ...
    bundles: {
      essential_core: 79,
      sales_engine: 479,
      marketing_campaigns: 479,
      portals_dashboards: 399,
      design_3d: 729,
      fullstack_saas: 799,
      // legacy aliases
      ecommerce_ordering: 479,
      booking_appointments: 479,
      lead_crm: 150,
      ai_assistant: 190,
      design_3d_gsap: 729,
      staff_portal: 399,
  ...
  EU: {
    ...
    bundles: {
      essential_core: 89,
      sales_engine: 549,
      marketing_campaigns: 549,
      portals_dashboards: 459,
      design_3d: 819,
      fullstack_saas: 899,
      // legacy aliases
      ecommerce_ordering: 549,
      booking_appointments: 549,
      lead_crm: 170,
      ai_assistant: 215,
      design_3d_gsap: 819,
      staff_portal: 459,
  ...
  AE: {
    ...
    bundles: {
      essential_core: 370,
      sales_engine: 2190,
      marketing_campaigns: 2190,
      portals_dashboards: 1820,
      design_3d: 3270,
      fullstack_saas: 3650,
      // legacy aliases
      ecommerce_ordering: 2190,
      booking_appointments: 2190,
      lead_crm: 680,
      ai_assistant: 860,
      design_3d_gsap: 3270,
      staff_portal: 1820,
