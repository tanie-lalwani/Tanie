  ...
  "growth-marketing-campaigns": [
    {
      ...
      is_core: true,
      display_order: 1,
      included_limit: "1-Click checkout engine with Apple Pay, Google Pay, UPI & Cards",
      feature_price_inr: 2500,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 2,
      included_limit: "Dynamic campaign countdown clocks and drop deadline tickers",
      feature_price_inr: 1000,
      feature_price_usd: 25,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 3,
      included_limit: "Sticky announcement header with 1-tap clipboard coupon copying",
      feature_price_inr: 800,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 4,
      included_limit: "Complete product showcase gallery with 4K zoom loupe & variants",
      feature_price_inr: 1800,
      feature_price_usd: 50,
      overage_unit_label: null,
      overage_price_inr: null,
      overage_price_usd: null
    },
    {
      ...
      is_core: true,
      display_order: 5,
      included_limit: "Editorial studio product presentations with interactive spec hotspots",
      feature_price_inr: 1500,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 6,
      included_limit: "Full vertical TikTok / Reels customer video reviews wall",
      feature_price_inr: 1500,
      feature_price_usd: 40,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 7,
      included_limit: "Side-by-side comparison tables against market alternatives",
      feature_price_inr: 1000,
      feature_price_usd: 25,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 8,
      included_limit: "Live purchase notification toasts and dynamic low-stock meters",
      feature_price_inr: 1000,
      feature_price_usd: 25,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 9,
      included_limit: "Lead magnet opt-in gate with instant digital asset delivery",
      feature_price_inr: 1000,
      feature_price_usd: 25,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 10,
      included_limit: "Full multi-source UTM attribution engine across all marketing channels",
      feature_price_inr: 1500,
      feature_price_usd: 40,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 11,
      included_limit: "Pre-wired Meta CAPI, GA4, GTM and TikTok conversion pixels",
      feature_price_inr: 1000,
      feature_price_usd: 30,
      overage_unit_label: null,
      overage_price_inr: null,
    ...
    },
    {
      ...
      is_core: true,
      display_order: 12,
      included_limit: "In-portal UTM campaign link builder with 1-click presets",
