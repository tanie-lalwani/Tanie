    ...
    <div className="ml-auto flex w-full items-center justify-end gap-2 overflow-hidden text-[11.5px] font-medium uppercase tracking-[0.2em] text-sky-200/90 sm:w-auto sm:gap-3" aria-labelledby="open-to-heading">
      ...
      <span className="relative h-5 min-w-[13.5rem] overflow-hidden text-right [mask-image:linear-gradient(to_bottom,transparent,black_22%,black_78%,transparent)]" aria-hidden="true">
        <AnimatePresence initial={false}>
          <motion.span
            key={activeService}
            className="absolute right-0 top-0 whitespace-nowrap text-sky-200/90"
  ...
  return (
    <main className="relative">
      <SEOHead
        ...
        description="Tanie Lalwani is a creative full-stack developer specializing in React.js, TypeScript, Three.js, and Next.js. Explore her portfolio, projects, experience, and  interview questions."
        ...
        <div className="site-container relative z-10">
          ...
          <div className="mt-5 grid w-full grid-cols-1 gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(14rem,20rem)] lg:items-start">
            <article className="max-w-[62ch]" aria-label="About Tanie Lalwani">
              ...
              <div className={`about-scroll ${isMobile ? "max-h-none overflow-visible" : "max-h-[calc(78svh-13rem)] sm:max-h-[calc(76vh-12rem)]"} space-y-3.5 pr-3 text-[13px] font-medium leading-7 tracking-normal text-slate-200/54 sm:text-[13.5px] ${!isMobile && aboutExpanded ? "overflow-y-auto" : (!isMobile ? "overflow-hidden" : "")}`}>
