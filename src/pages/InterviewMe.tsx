    ...
    <div className="site-shell bg-[#dff4ff] text-black">
      <nav className="fixed left-0 top-0 z-40 hidden h-full w-20 flex-col items-center justify-between border-r border-black/10 bg-[#dff4ff]/88 py-8 backdrop-blur-xl md:flex">
        ...
        <div className="mb-2 flex flex-col items-center gap-4">
          <a href="https://github.com/taniehq" target="_blank" rel="noopener" className="flex h-12 w-12 items-center justify-center rounded-[1.1rem] border border-black/10 bg-white/45 !text-black transition-colors duration-150 hover:bg-white/70 hover:!text-black" title="GitHub">
