...
import { getSavedLeadProfile, saveLeadProfile } from "../lib/cookieHelper";
...
export function ContactForm() {
  ...
  const updateField = (key: keyof ContactFields, value: string) => {
    ...
    if (key === "name") saveLeadProfile({ name: value });
    if (key === "email") saveLeadProfile({ email: value });
  };
