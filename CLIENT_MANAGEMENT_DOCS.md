...
| **Aesthetic / Packages (`/packages`)** | Prospects exploring design archetypes | Light ocean blue background (`#dff4ff`), palette swatches, tech stack tags, and instant inquiry modal. |
...
| [`supabase_schema.sql`](file:///c:/Users/words/Desktop/Websites/Completed/Portfolio/supabase_schema.sql) | Full PostgreSQL database migrations, indexes, and RLS policies. |
